...
def train(graph_matrix, true_label, train_data, test_data, kmer_length, result_path, data_info, random_seed, result_dir_path, GPU_option):
    ...
    with tf.Session(config = config) as sess:
        ...
        for i in range(steps):
            _, total_cross_entropy, total_train_accuracy, total_train_auc = sess.run([train_step, cross_entropy, train_accuracy, train_auc], feed_dict={x11: A11, x12: A12, x21: A21, x22: A22, v11: B11, v12: B12, v21: B21, v22: B22, z11: feature11,
            ...
            if i % 50 == 0:
                ...
                total_test_accuracy, total_test_auc, summary = sess.run([test_accuracy, test_auc, merged],
                                                                        feed_dict={x11: A11, x12: A12, x21: A21,
                                                                                   x22: A22, v11: B11, v12: B12,
                                                                                   v21: B21, v22: B22, z11: feature11,
